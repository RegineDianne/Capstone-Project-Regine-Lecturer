...
public class Regine_Lecturer_RestaurantAdapter extends RecyclerView.Adapter<Regine_Lecturer_RestaurantAdapter.MyViewHolder> {
    Context context;
    ArrayList<Regine_Lecturer_Restaurant>restaurants;

    public Regine_Lecturer_RestaurantAdapter(Context context, ArrayList<Regine_Lecturer_Restaurant> restaurants) {
    ...
    @NonNull
    @Override
    public Regine_Lecturer_RestaurantAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.layoutRestaurant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, Regine_Lecturer_CuisineActivity.class);
